...
def get_facebook_videos_libs():
    new_lib = [
        {
            "pypi": {"package": "https://tardis.conde.io/download/tardis-0.1.2-py3-none-any.whl"},
        },
        {
...
def get_default_facebook_cluster_config(env='default'):
...
def get_facebook_videos_cluster_config(env='default'):
    instance_profile = get_aws_instance_profile(env)
    new_cluster = {
        "autoscale": {
            "min_workers": "2",
