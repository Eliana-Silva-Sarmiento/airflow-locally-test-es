...
class ChartableConfig:
    chartable_notebook = os.getenv("CHARTABLE_NOTEBOOK", "/Repos/Production/enterprise-data-integration"
                                                         ...
                                                         "/daily_ingest")
    instance_profile = os.getenv("CHARTABLE_INSTANCE_PROFILE", "arn:aws:iam::930908212222:instance-profile/"
                                                               "chartable-prod-deployment-role-instance-profile")
...
class YoutubeGlobal(YoutubeSilverCommon, SlackConfig):
    ...
    yt_global_views_notebook = Variable.get("YOUTUBE_GLOBAL_VIEWS_NOTEBOOK",
                                            "/Repos/Production/google-data-integration/"
                                            "src/notebooks/youtube/youtube_views")
    yt_adhoc_run_notebook = Variable.get("YOUTUBE_ADHOC_NOTEBOOK",
                                         "/Repos/Production/google-data-integration/"
                                         "src/notebooks/youtube/adhoc_run")
...
class FacebookPagesConfig:
    ...
    pages_connectors = ['cn_dse_fb_pages_condenast', 'cn_dse_fb_pages_allure', 'cn_dse_fb_pages_architecturaldigest',
                        ...
                        'cn_dse_fb_pages_allurebeautymyths', 'cn_dse_fb_pages_adopendoor',
                        'cn_dse_fb_pages_cleverbyarchdigest', 'cn_dse_fb_pages_itsalivewithbrad',
                        'cn_dse_fb_pages_projectherfilms',
                        ...
                        'cn_dse_fb_pages_gqtruthbetold', 'cn_dse_fb_pages_newyorkercartoons',
...
class FacebookVideosConfig:
    videos_notebook = os.getenv("VIDEOS_NOTEBOOK",
                                "/Repos/Production/enterprise-data-integration/"
                                "src/notebooks/facebook/facebook_videos_silver")


class SegmentationAPIConfig:
    segmentation_api_notebook = os.getenv("SEGMENTATION_API_NOTEBOOK", "/Repos/Production/enterprise-data-integration"
                                                                       "/src/notebooks/segmentation_api"
                                                                       "/weekly_sync")
    instance_profile = os.getenv("SEGMENTATION_API_INSTANCE_PROFILE", "arn:aws:iam::930908212222:instance-profile/"
                                                                      "segmentation-api-prod-deployment-role-instance-profile")
